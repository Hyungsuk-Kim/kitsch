	...
	<!-- blog header -->
		<div class="container-fluid">
			<div class="img_center" style="background-image: url(${requestScope.blog.headerImage})">
				<div>
					<span class="text-left">${blogOwner.name}</span>
					<c:if test="${sessionScope.logonMember.email eq  blog.email}">
						<a href="/kitsch/blog?action=remove&blogName=${requestScope.blog.blogName}" class="text-right">블로그 삭제</a>
						<div>
